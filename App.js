...
// ✅ Login Screen using Firebase SDK Auth
    ...
    <View style={styles.container}>
      ...
      {tickets.map((ticket, index) => (
        <View key={index} style={styles.ticketItem}>
          ...
          <TouchableOpacity style={styles.descButton} onPress={() => showDescription(ticket.description)}>
            <Text style={styles.buttonText}>Description</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.buyButton} onPress={() => handleBuyNow(ticket.name)}>
            <Text style={styles.buyButtonText}>Buy Now</Text>
          </TouchableOpacity>
        </View>
      ))}
      <TouchableOpacity style={styles.buyButton} onPress={() => navigation.navigate('View Cart', { cartItems })}>
        <Text style={styles.buyButtonText}>View Cart</Text>
      </TouchableOpacity>
    </View>
  );
}
...
// View Cart Screen
function ViewCartScreen({ route, navigation }) {
  const { cartItems = [] } = route.params || {};
  return (
    <View style={styles.container}>
      <Text style={styles.title}>🛒 Your Cart</Text>
      {cartItems.length === 0 ? (
        <Text style={styles.ticketText}>Your cart is empty.</Text>
      ) : (
        <>
          ...
          <TouchableOpacity style={styles.buyButton} onPress={() => navigation.navigate('Checkout', { cartItems })}>
            <Text style={styles.buyButtonText}>Go to Checkout</Text>
          </TouchableOpacity>
        </>
      )}
    </View>
...
function CheckoutScreen({ route, navigation }) {
  ...
  const handleManualPayment = () => {
    Alert.alert('Bank Transfer Instructions', 'Please send payment to:\n\nBank: ABC Bank\nAccount: 123456789\nName: Farward876\n\nAfter payment, contact us on WhatsApp to confirm.');
  };

  const handleCardPayment = () => {
    Alert.alert('Card Payment Unavailable', 'Credit/Debit Card payments will be available soon.');
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.buyButton} onPress={handleCardPayment}>
        <Text style={styles.buyButtonText}>Pay with Card</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.buyButton} onPress={handleManualPayment}>
        <Text style={styles.buyButtonText}>Pay by Bank Transfer</Text>
      </TouchableOpacity>
...
function OrderConfirmationScreen({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Your purchase was successful.</Text>
      <TouchableOpacity style={styles.buyButton} onPress={() => navigation.replace('Home')}>
        <Text style={styles.buyButtonText}>Return to Home</Text>
      </TouchableOpacity>
    </View>
  );
}
...
function ContactScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.buyButton} onPress={handleCall}>
        <Text style={styles.buyButtonText}>Call Us</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.buyButton} onPress={handleWhatsApp}>
        <Text style={styles.buyButtonText}>Message on WhatsApp</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.buyButton} onPress={handleEmail}>
        <Text style={styles.buyButtonText}>Send Email</Text>
      </TouchableOpacity>
    </View>
  );
}
...
function ManageTicketsScreen() {
  ...
  const handleSaveTicket = async () => {
    ...
    try {
      ...
      await setDoc(docRef, { name, price: parseFloat(price), description, date });
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.buyButton} onPress={handleSaveTicket}>
        <Text style={styles.buyButtonText}>Save Ticket</Text>
      </TouchableOpacity>
    </View>
  );
}
...
function DrawerMenu({ route, navigation }) {
  ...
  return (
    <Drawer.Navigator initialRouteName="Home">
      ...
      <Drawer.Screen name="View Cart" component={ViewCartScreen} />
      <Drawer.Screen name="Checkout" component={CheckoutScreen} />
      <Drawer.Screen name="Order Confirmation" component={OrderConfirmationScreen} />
